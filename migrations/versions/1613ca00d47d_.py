...
Revision ID: 1613ca00d47d
Revises: a5cffa318ac2
Create Date: 2024-12-17 00:07:57.125403
...
def upgrade():
    ...
    op.create_table('create__character',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('create__planet',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('create__vehicle',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    ...
    op.create_table('favorito__character',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('favorito__planet',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('favorito__vehicle',
    sa.Column('id', sa.Integer(), nullable=False),
...
def downgrade():
    ...
    op.drop_table('favorito__vehicle')
    op.drop_table('favorito__planet')
    op.drop_table('favorito__character')
    op.drop_table('create__vehicle')
    op.drop_table('create__planet')
    op.drop_table('create__character')
